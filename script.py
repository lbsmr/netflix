...
pie_2.update_layout(uniformtext_minsize=12, uniformtext_mode='hide',paper_bgcolor='rgba(0,0,0,0)',plot_bgcolor='rgba(0,0,0,0)',font=dict(family = 'Arial',color = '#F8F8FF'),)
...
app.layout = html.Div(children=[
    ...
    html.Div(children = [
        html.H2("Crew members appearances on Netflix and average IMDb rating"),
        html.Div(className = 'left_content' , children=[
